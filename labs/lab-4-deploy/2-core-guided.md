...
24. Visit the URL and verify your app is live

**Expected output:** Your frontend is deployed to GitHub Pages automatically on merge to main. The dashboard is accessible at your live URL. The Environments tab shows your deployment history. The dashboard shows "Summary not yet available" (because the static site does not have a backend — this is expected for Pages).
