...
3. Add a basic test skeleton to your template file. For example (Node/Jest):
...
6. Add the skill body below the frontmatter. Reference your template file using a relative path:
   ...
   1. Use the test template in [test-template.js](./test-template.js) as a starting point
